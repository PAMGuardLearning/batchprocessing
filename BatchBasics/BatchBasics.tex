...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, colframe=quarto-callout-note-color-frame, toptitle=1mm, opacitybacktitle=0.6, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{My personal data processing record}, left=2mm, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, colback=white, toprule=.15mm, bottomtitle=1mm, arc=.35mm, rightrule=.15mm, leftrule=.75mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, colframe=quarto-callout-important-color-frame, toptitle=1mm, opacitybacktitle=0.6, breakable, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Feedback}, left=2mm, bottomrule=.15mm, colbacktitle=quarto-callout-important-color!10!white, coltitle=black, colback=white, toprule=.15mm, bottomtitle=1mm, arc=.35mm, rightrule=.15mm, leftrule=.75mm, opacityback=0]
...
click classification. Click on the \textbf{Configure Task} button for
Reclassify Clicks, then in the dialog (Figure~\ref{fig-reclass1}), then
press the \textbf{New} button to open the Click Parameters dialog
(Figure~\ref{fig-reclass2}). In the bottom right from \textbf{Set
Defaults} select \emph{Porpoise} which will set default values for
