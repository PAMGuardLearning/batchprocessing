...
\begin{tcolorbox}[enhanced jigsaw, breakable, opacitybacktitle=0.6, bottomrule=.15mm, arc=.35mm, coltitle=black, colback=white, leftrule=.75mm, toprule=.15mm, bottomtitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, titlerule=0mm, toptitle=1mm, opacityback=0, left=2mm, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{PAMGuard configuration files}, colframe=quarto-callout-tip-color-frame]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, opacitybacktitle=0.6, bottomrule=.15mm, arc=.35mm, coltitle=black, colback=white, leftrule=.75mm, toprule=.15mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, toptitle=1mm, opacityback=0, left=2mm, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{My personal data processing record}, colframe=quarto-callout-note-color-frame]
...
part of the \href{https://compass-oceanscience.eu/}{Compass Project}.
We've taken a single days data for each recorder since the full dataset
would be too large for a tutorial exercise and might take many days to
process.
...
\begin{tcolorbox}[enhanced jigsaw, breakable, opacitybacktitle=0.6, bottomrule=.15mm, arc=.35mm, coltitle=black, colback=white, leftrule=.75mm, toprule=.15mm, bottomtitle=1mm, colbacktitle=quarto-callout-important-color!10!white, titlerule=0mm, toptitle=1mm, opacityback=0, left=2mm, rightrule=.15mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Feedback}, colframe=quarto-callout-important-color-frame]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, opacitybacktitle=0.6, bottomrule=.15mm, arc=.35mm, coltitle=black, colback=white, leftrule=.75mm, toprule=.15mm, bottomtitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, titlerule=0mm, toptitle=1mm, opacityback=0, left=2mm, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Impatient ?}, colframe=quarto-callout-tip-color-frame]
